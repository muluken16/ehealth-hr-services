...
<body>
                ...
                <form id="registrationForm" method="POST" action="">
                    <div class="form-card">
                        ...
                        <div class="form-step" data-step="2">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="position" placeholder="e.g., Senior Nurse, HR Manager"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label>Department</label>
                                    <select name="department_assigned"
                                        onchange="toggleOtherField(this, 'other_dept_group_reg')">
                                        ...
                                        <option value="Maternal and Child Health (MCH)">Maternal and Child Health (MCH)
                                        </option>
                                        ...
                                        <option value="Medical Records / Health Information Management">Medical Records
                                            / Health Information Management</option>
                                        <option value="Administration and Finance">Administration and Finance</option>
                                        <option value="other">Other (please specify)</option>
                                    </select>
                                </div>
                                <div class="form-group" id="other_dept_group_reg" style="display:none;">
                                    <label>Specify Department <span class="required">*</span></label>
                                    <input type="text" name="other_department_assigned"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="employment_type"
                                        onchange="toggleOtherField(this, 'other_employment_group_reg')">
                                ...
                                <div class="form-group" id="other_employment_group_reg" style="display:none;">
                                    <label>Specify Employment Type <span class="required">*</span></label>
                                    <input type="text" name="other_employment_type" placeholder="Enter employment type">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-step" data-step="3">
                            ...
                            <p class="form-step-description">Enter the employee's address and emergency contact details
                            </p>
                            ...
                            <div class="form-grid single-column">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" rows="3"
                                        placeholder="Enter complete address details (street, house number, etc.)"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Emergency Contact</label>
                                    <input type="text" name="emergency_contact"
                                        placeholder="Name and phone number of emergency contact">
                                    <span class="input-hint"><i class="fas fa-phone-alt"></i> Person to contact in case
                                        of emergency</span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function populateReview() {
            ...
            let deptDisp = formData.get('department_assigned');
            if (deptDisp === 'other') deptDisp = formData.get('other_department_assigned') || 'Other';
            html += `<p><strong>Department:</strong> ${deptDisp || 'Not specified'}</p>`;
            html += `<p><strong>Job Level:</strong> ${formData.get('job_level') || 'Not specified'}</p>`;
            let empTypeDisp = formData.get('employment_type');
            if (empTypeDisp === 'other') empTypeDisp = formData.get('other_employment_type') || 'Other';
            html += `<p><strong>Employment Type:</strong> ${empTypeDisp}</p>`;
