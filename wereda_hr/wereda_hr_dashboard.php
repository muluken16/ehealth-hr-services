            ...
            <div class="hr-dashboard">
                ...
                <div class="welcome-banner">
                    <div class="welcome-content">
                        ...
                        <p>Here's what's happening with your Woreda workforce today. You have <span
                                class="highlight"><?php echo $pendingLeave; ?> pending</span> leave requests to review.
                        </p>
                    </div>
                ...
                <div class="hr-actions">
                    <div class="hr-action-btn" onclick="window.location.href='add_employee.php'">
                        <i class="fas fa-user-plus"></i>
                        <span>Add New Employee</span>
                    </div>
                    <div class="hr-action-btn" onclick="window.location.href='wereda_hr_payroll.php'">
                        <i class="fas fa-money-check-alt"></i>
                        <span>Process Payroll</span>
                    </div>
                    <div class="hr-action-btn" onclick="window.location.href='wereda_hr_recruitment.php'">
                        <i class="fas fa-bullhorn"></i>
                        <span>Post New Job</span>
                    </div>
                    <div class="hr-action-btn" onclick="window.location.href='wereda_hr_training.php'">
                        <i class="fas fa-graduation-cap"></i>
                        <span>Schedule Training</span>
                    </div>
                    <div class="hr-action-btn" onclick="window.location.href='wereda_hr_reports.php'">
                        <i class="fas fa-file-pdf"></i>
                        <span>Generate Report</span>
                    </div>
                    <div class="hr-action-btn" onclick="window.location.href='wereda_hr_leave.php'">
                        ...
                        <div class="charts-container"
                            ...
                            <div class="chart-container-premium" style="height: 350px; position: relative;">
                                <canvas id="genderChart"
                                    style="height: 300px !important; width: 100% !important;"></canvas>
                            </div>
                            <div class="chart-container-premium" style="height: 350px; position: relative;">
                ...
                <div class="hr-section">
                    <div class="hr-section-header">
                        ...
                        <div class="hr-section-actions">
                            <button class="section-action-btn"
                                onclick="window.location.href='wereda_hr_employee.php?add=true'">
                        ...
                        <div class="table-container">
                            <table class="table">
                                ...
                                <tbody>
                                        ...
                                        <?php foreach ($employees as $employee): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="Employee ID">
                                                    <?php echo htmlspecialchars($employee['employee_id']); ?></td>
                                                <td data-label="Department"><span
                                                        class="department-badge <?php echo $deptClass; ?>"><?php echo htmlspecialchars($dept); ?></span>
                                                </td>
                                                <td data-label="Position"><?php echo htmlspecialchars($employee['position']); ?>
                                                </td>
                                                <td data-label="Join Date"><?php echo $joinDate; ?></td>
                                                <td data-label="Status"><span
                                                        class="status-badge <?php echo $statusClass; ?>"><?php echo $status; ?></span>
                                                </td>
                                                <td data-label="Actions">
                                                    <div class="action-buttons">
                                                        <button class="action-btn view"
                                                            onclick="window.location.href='wereda_hr_employee.php?id=<?php echo $employee['id']; ?>'"><i
                                                                class="fas fa-eye"></i></button>
                                                        <button class="action-btn edit"
                                                            onclick="window.location.href='wereda_hr_employee.php?id=<?php echo $employee['id']; ?>&edit=true'"><i
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="7" style="text-align:center; padding: 20px;">No employees found.
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                                ...
                                <?php foreach ($activities as $act): ?>
                                    <div class="timeline-item">
                                        <div class="timeline-icon"
                                            style="background: <?php echo $act['bg']; ?>; color: <?php echo $act['color']; ?>;">
                                            <i class="fas fa-<?php echo $act['type']; ?>"></i>
                                        </div>
                                        <div class="timeline-content">
                                            <div class="timeline-header">
                                                <span
                                                    class="timeline-title"><?php echo htmlspecialchars($act['title']); ?></span>
                                ...
                                <?php foreach ($leaveRequests as $request): ?>
                                    ...
                                    <div class="leave-request-card">
                                        <div class="leave-header">
                                            <div class="leave-employee">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="employee-id">
                                                        <?php echo htmlspecialchars($request['department_assigned']); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <p style="margin-bottom: 15px; color: var(--gray);">
                                            <?php echo htmlspecialchars($request['reason'] ?: 'No reason provided.'); ?></p>
                                        <div class="leave-actions">
                                            <button class="leave-action-btn approve"
                                                onclick="approveLeave(<?php echo $request['id']; ?>)">Approve</button>
                                            <button class="leave-action-btn reject"
                                                onclick="rejectLeave(<?php echo $request['id']; ?>)">Reject</button>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                                    ...
                                    <div class="job-card">
                                        <div class="job-header">
                                            <div>
                                                ...
                                                <div class="job-department"><?php echo htmlspecialchars($job['department']); ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="job-actions">
                                            <button class="job-action-btn"
                                                onclick="alert('Viewing details for <?php echo htmlspecialchars($job['title']); ?>')">View
                                                Details</button>
                                            <button class="job-action-btn"
                                                onclick="alert('Editing <?php echo htmlspecialchars($job['title']); ?> posting')">Edit</button>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                                ...
                                <?php foreach ($trainings as $training): ?>
                                    ...
                                    <div class="training-card">
                                        <div class="training-header">
                                            <div>
                                                <div class="training-title"><?php echo htmlspecialchars($training['title']); ?>
                                                </div>
                                                <div class="training-category">
                                                    <?php echo htmlspecialchars($training['category'] ?? 'Professional Development'); ?>
                                                </div>
                                            </div>
                                            <div class="training-status upcoming"><?php echo ucfirst($training['status']); ?>
                                            </div>
                                        </div>
