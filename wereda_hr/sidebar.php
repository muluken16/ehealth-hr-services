...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <a href="wereda_hr_dashboard.php" class="logo">
            <i class="fas fa-id-card-alt"></i>
            <span class="logo-text">Woreda HR</span>
        </a>
    ...
    <nav class="sidebar-menu">
        <ul>
            ...
            <li class="menu-item <?php echo $current_page == 'wereda_hr_employees.php' ? 'active' : ''; ?>">
                <a href="wereda_hr_employees.php">
            ...
            <li
                class="menu-item <?php echo ($current_page == 'wereda_hr_attendance.php' || $current_page == 'hr-attendance.php') ? 'active' : ''; ?>">
                <a href="wereda_hr_attendance.php">
