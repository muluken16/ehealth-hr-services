...
<body>
            ...
            <div class="filters-section">
                ...
                <select class="filter-select" id="kebeleFilter">
                    ...
                    <?php foreach ($kebeles as $k): ?>
                        <option value="<?php echo htmlspecialchars($k); ?>">Kebele <?php echo htmlspecialchars($k); ?>
                        </option>
                    <?php endforeach; ?>
                </select>
    ...
    <script>
        ...
        function loadEmployees(page = 1) {
            ...
            const url = `get_wereda_hr_employees.php?page=${page}&limit=${itemsPerPage}&search=${encodeURIComponent(searchTerm)}&department=${encodeURIComponent(dept)}&status=${status}&kebele=${encodeURIComponent(kebele)}`;
