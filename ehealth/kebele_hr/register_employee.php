...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        if ($stmt->execute()) {
            ...
            header("refresh:2;url=hr-employees.php");
        } else {
...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .keyboard-hint, .autosave-indicator {
                            ...
                            <div class="form-step" data-step="2">
                                ...
                                <div class="form-grid">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="position" placeholder="e.g., Nurse, Health Officer" required>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="form-step" data-step="3">
                                ...
                                <div class="form-grid single-column">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" rows="3" placeholder="Enter complete address details"></textarea>
                                    </div>
                                    <div class="form-group">
