...
foreach ($medicines as $medicine) {
    ...
    $stmt->bind_param("sisssssss", $medicine, $quantity, $expiry, $supplier, $min_stock, $zone, $woreda, $kebele);
    $stmt->execute();
    $stmt->close();
}
...
foreach ($supplies as $supply) {
    ...
    $stmt->bind_param("sissssss", $supply, $quantity, $supplier, $min_stock, $zone, $woreda, $kebele);
    $stmt->execute();
    $stmt->close();
}
