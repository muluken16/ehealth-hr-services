    ...
    <div class="hr-container">
        ...
        <div class="hr-dashboard">
            ...
            <div class="hr-actions">
                <div class="hr-action-btn" onclick="window.location.href='zone_hr_employee.php'">
                    <i class="fas fa-user-plus"></i>
                    <span>Manage Employees</span>
                </div>
                <div class="hr-action-btn" onclick="window.location.href='zone_hr_payroll.php'">
                    <i class="fas fa-money-check-alt"></i>
                    <span>Process Payroll</span>
                </div>
                <div class="hr-action-btn" onclick="window.location.href='zone_hr_attendance.php'">
                    <i class="fas fa-calendar-check"></i>
                    <span>Attendance</span>
                </div>
                <div class="hr-action-btn" onclick="window.location.href='zone_hr_recruitment.php'">
                    <i class="fas fa-bullhorn"></i>
                    <span>Post New Job</span>
                </div>
                <div class="hr-action-btn" onclick="window.location.href='zone_hr_training.php'">
                    <i class="fas fa-graduation-cap"></i>
                    <span>Schedule Training</span>
                </div>
                <div class="hr-action-btn" onclick="window.location.href='zone_hr_reports.php'">
                    <i class="fas fa-file-pdf"></i>
                    <span>Generate Report</span>
                </div>
                <div class="hr-action-btn" onclick="window.location.href='zone_hr_leave.php'">
                    <i class="fas fa-clipboard-list"></i>
                    <span>Leave Requests</span>
                    <span
                        style="font-size: 0.8rem; margin-top: 5px; color: var(--accent);"><?php echo $pending_leaves; ?>
                        pending</span>
                </div>
            </div>
