...
if (isset($_SESSION['user_id'])) {
    ...
    else if (strpos($role, 'zone') !== false)
        $redirectUrl = $role . '/' . $role . '_dashboard.php';
    else if (strpos($role, 'wereda') !== false)
        $redirectUrl = $role . '/' . $role . '_dashboard.php';
    else if (strpos($role, 'kebele') !== false)
        $redirectUrl = $role . '/' . $role . '_dashboard.php';
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 900px) {
            body {
                background: #f0f4f8;
                /* Changed from white to give contrast */
                overflow-y: auto;
                height: auto;
                padding: 40px 20px;
            }
            ...
            .login-container {
                ...
                height: auto;
                min-height: unset;
                /* Allow it to wrap content */
                width: 100%;
                max-width: 500px;
                /* Center it like a card on mobile */
                margin: 0 auto;
                border-radius: 24px;
                /* Keep the premium rounded look */
            ...
            .image-section {
                flex: none;
                height: 220px;
                /* Slightly taller for visual balance */
                padding: 30px;
...
<body>
    <div class="login-container">
        ...
        <div class="form-section">
            <div class="form-header">
                ...
                <p id="pageSubtitle">Please enter your credentials to access the system</p>
            </div>
            ...
            <div class="demo-section">
                ...
                <div class="demo-grid">
                    <div class="demo-chip" style="grid-column: span 2;"
                        onclick="fillLogin('admin@gmail.com', '123456')">Administrator</div>
            ...
            <div style="margin-top: 25px; text-align: center;">
                <p style="font-size: 0.85rem; color: #94a3b8;">
                    Need help? <a href="mailto:support@healthfirst.com"
                        style="color: var(--primary); font-weight: 600; text-decoration: none;">IT Support</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        // Check if user is applying for a job
        const urlParams = new URLSearchParams(window.location.search);
        const jobId = urlParams.get('job_id');

        if (jobId) {
            document.getElementById('pageTitle').textContent = 'Apply for Position';
            document.getElementById('pageSubtitle').textContent = 'Please login to submit your application';
            // Store job_id for after login
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    // Check if user was applying for a job
                    ...
                    if (applyJobId) {
                        // User was applying for a job, redirect to applications page
                        sessionStorage.removeItem('apply_job_id');
                        redirectUrl = 'kebele_hr/view_applications.php?job_id=' + applyJobId;
                    } else if (role === 'admin') {
                        redirectUrl = 'admin_dashboard.php';
                    } else {
