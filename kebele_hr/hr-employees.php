...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Auto-open details if requested (e.g. from dashboard)
            const viewId = urlParams.get('view_id');
            if (viewId) {
                // Wait slightly for data loading or just fetch directly
                // viewEmployeeDetails handles fetching if not in local list
                setTimeout(() => window.viewEmployeeDetails(viewId), 500);
            }
