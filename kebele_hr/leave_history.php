...
$_SESSION['kebele'] = $_SESSION['kebele'] ?? 'Kebele 1';

// Get current user's kebele for filtering
...
// Build query - Always filter by kebele for security
$where_conditions = [];
$params = [];
$param_types = '';

// Always filter by the logged-in HR's kebele
$where_conditions[] = "(e.working_kebele = ? OR e.kebele = ?)";
$params[] = $user_kebele;
$params[] = $user_kebele;
$param_types .= 'ss';
...
// Get employees for filter dropdown - filtered by kebele
$employees_stmt = $conn->prepare("SELECT DISTINCT employee_id, first_name, last_name FROM employees WHERE working_kebele = ? OR kebele = ? ORDER BY first_name, last_name");
$employees_stmt->bind_param("ss", $user_kebele, $user_kebele);
                ...
                <div class="stats-row">
                    <div class="stat-card">
                        <div class="stat-number">
                            <?php echo count(array_filter($leave_requests, fn($r) => $r['status'] === 'pending')); ?>
                        </div>
                        <div class="stat-label">Pending</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number">
                            <?php echo count(array_filter($leave_requests, fn($r) => $r['status'] === 'approved')); ?>
                        </div>
                        <div class="stat-label">Approved</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number">
                            <?php echo count(array_filter($leave_requests, fn($r) => $r['status'] === 'rejected')); ?>
                        </div>
                    ...
                    <form method="GET">
                        <div class="filters-row">
                            ...
                            <div class="filter-group">
                                ...
                                <input type="text" id="employee" name="employee" placeholder="Search by name or ID..."
                            ...
                            <div class="filter-actions">
                                ...
                                <button type="button" class="filter-btn secondary"
                                    onclick="window.location.href='leave_history.php'">
                                        ...
                                        <tr>
                                            <td>
                                                <div>
                                                    ...
                                                    <br>
                                                    <small
                                                        style="color: #6c757d;"><?php echo htmlspecialchars($request['employee_id']); ?></small>
                                                    <br>
                                                    <small
                                                        style="color: #6c757d;"><?php echo htmlspecialchars($request['position'] ?? 'N/A'); ?></small>
                                                </div>
                                            </td>
                                            <td>
