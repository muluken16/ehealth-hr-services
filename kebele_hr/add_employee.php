...
if (!isset($_SESSION['woreda'])) $_SESSION['woreda'] = 'Woreda 1';
if (!isset($_SESSION['kebele'])) $_SESSION['kebele'] = '01';
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="add-layout">
                    ...
                    <div class="nav-card">
                        ...
                        <div class="nav-sections">
                            ...
                            <div class="nav-item" data-section="education"><i class="fas fa-graduation-cap"></i> Education</div>
                            <div class="nav-item" data-section="employment"><i class="fas fa-briefcase"></i> Employment</div>
                            <div class="nav-item" data-section="location"><i class="fas fa-map-marker-alt"></i> Contact</div>
                            ...
                            <div class="nav-item" data-section="documents"><i class="fas fa-folder-open"></i> Documents</div>
                        </div>
                    </div>
                            ...
                            <div id="assignment">
                                ...
                                <div class="form-grid">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="working_woreda" class="form-control-edit" value="<?php echo htmlspecialchars($_SESSION['woreda']); ?>" readonly style="background: #e2e8f0; cursor: not-allowed;">
                                    </div>
                                    <div class="form-group">
                                        <label>Working Kebele (Auto)</label>
                                        <input type="text" name="working_kebele" class="form-control-edit" value="<?php echo htmlspecialchars($_SESSION['kebele']); ?>" readonly style="background: #e2e8f0; cursor: not-allowed;">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                            <div>
                                                ...
                                                <div class="upload-area" onclick="document.getElementById('loan_file_input').click()" style="padding: 10px;">
                                                    ...
                                                    <input type="file" id="loan_file_input" name="loan_file" accept=".pdf,image/*" style="display:none" onchange="handleSingleFile(this, 'loan_file_display')">
                                                </div>
                                            </div>
                                            <div>
                                    ...
                                    <div id="warrantyFields" class="form-grid" style="grid-column: 1 / -1; display: grid; margin-bottom: 0;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="finScanGroup" style="display: none; margin-top: 10px;">
                                                <div class="upload-area" onclick="document.getElementById('fin_scan_input').click()" style="padding: 8px; border-style: dashed; background: #f0f7ff;">
                                                    ...
                                                    <input type="file" id="fin_scan_input" name="fin_scan" accept=".pdf,image/*" style="display:none" onchange="handleSingleFile(this, 'fin_scan_display')">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="upload-area" onclick="document.getElementById('warranty_file').click()">
                                                ...
                                                <input type="file" id="warranty_file" name="scan_file" style="display:none" onchange="handleSingleFile(this, 'warranty_file_display')">
                                            </div>
                                        ...
                                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                                            <div>
                                                ...
                                                <div class="upload-area" onclick="document.getElementById('criminal_file_input').click()" style="padding: 10px;">
                                                    ...
                                                    <input type="file" id="criminal_file_input" name="criminal_file" accept=".pdf,image/*" style="display:none" onchange="handleSingleFile(this, 'criminal_file_display')">
                                                </div>
