                            ...
                            row.innerHTML = `
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="action-btn view" onclick="window.location.href='hr-employees.php?view_id=${empId}'" title="View Details"><i class="fas fa-eye"></i></button>
                                        <button class="action-btn edit" onclick="window.location.href='edit_employee.php?id=${empId}'" title="Edit Profile"><i class="fas fa-edit"></i></button>
                                        <button class="action-btn delete" onclick="deleteEmployee('${empId}')" title="Delete"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            `;
