...
<body>
            ...
            <form id="addEmployeeForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="department_assigned" required>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Region</label>
                        <select id="region_dashboard" name="region" onchange="loadZones('_dashboard')">
                    ...
                    <div class="form-group">
                        <label>Zone</label>
                        <select id="zone_dashboard" name="zone" onchange="loadWoredas('_dashboard')">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Woreda</label>
                        <select id="woreda_dashboard" name="woreda" onchange="loadKebeles('_dashboard')">
                            <option value="">Select Woreda</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Kebele</label>
                        <select id="kebele_dashboard" name="kebele">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const scheduleTrainingBtn2 = document.getElementById('scheduleTrainingBtn2');
            const generateReportBtn = document.getElementById('generateReportBtn');
            const leaveRequestsBtn = document.getElementById('leaveRequestsBtn');

            if (processPayrollBtn) processPayrollBtn.addEventListener('click', () => window.location.href = 'hr-payroll.php');
            if (postJobBtn) postJobBtn.addEventListener('click', () => window.location.href = 'hr-recruitment.php');
            if (postJobBtn2) postJobBtn2.addEventListener('click', () => window.location.href = 'hr-recruitment.php');
            if (scheduleTrainingBtn) scheduleTrainingBtn.addEventListener('click', () => window.location.href = 'hr-training.php');
            if (scheduleTrainingBtn2) scheduleTrainingBtn2.addEventListener('click', () => window.location.href = 'hr-training.php');
            if (generateReportBtn) generateReportBtn.addEventListener('click', () => window.location.href = 'hr-reports.php');
            if (leaveRequestsBtn) leaveRequestsBtn.addEventListener('click', () => window.location.href = 'hr-leave.php');
