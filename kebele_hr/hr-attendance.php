            ...
            <div class="content">
                    ...
                    <div class="hr-section-header">
                        ...
                        <div class="hr-section-actions">
                            <div class="date-picker-container">
                                <input type="date" id="attendanceDate" class="date-picker-input"
                ...
                <div class="hr-section">
                    <div class="hr-section-header">
                        ...
                        <div class="hr-section-actions">
                            <select id="statusFilter" class="section-action-btn"
                                style="border: 1px solid var(--gray); color: var(--dark);">
