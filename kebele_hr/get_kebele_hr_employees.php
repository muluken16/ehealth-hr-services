...
try {
    ...
    // Build query with filters - Show employees from HR's kebele OR with matching working_kebele
    $sql = "SELECT * FROM employees WHERE (kebele = ? OR working_kebele = ?) ";
    $params = [$user_kebele, $user_kebele];
    $types = "ss";
    ...
    $countSql = "SELECT COUNT(*) as total FROM employees WHERE (kebele = ? OR working_kebele = ?) ";
    $countParams = [$user_kebele, $user_kebele];
    $countTypes = "ss";
