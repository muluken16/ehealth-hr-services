...
try {
    ...
    // Build query with filters - Filter by WORKING assignment, not residence
    $sql = "SELECT * FROM employees WHERE working_woreda = ? AND working_kebele = ? ";
    $params = [$user_woreda, $user_kebele];
    $types = "ss";
    ...
    // Get total count for pagination
    $countSql = "SELECT COUNT(*) as total FROM employees WHERE working_woreda = ? AND working_kebele = ? ";
    $countParams = [$user_woreda, $user_kebele];
    $countTypes = "ss";
