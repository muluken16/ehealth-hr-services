            ...
            <form id="enhancedAddEmployeeForm">
                ...
                <div class="form-step" data-step="3">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label>Region</label>
                            <select id="region_modal" name="region" class="form-input" onchange="loadZones('_modal')">
                        ...
                        <div class="form-group">
                            <label>Zone</label>
                            <select id="zone_modal" name="zone" class="form-input" onchange="loadWoredas('_modal')">
                                <option value="">Select Zone</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Woreda</label>
                            <select id="woreda_modal" name="woreda" class="form-input" onchange="loadKebeles('_modal')">
                                <option value="">Select Woreda</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Kebele</label>
                            <select id="kebele_modal" name="kebele" class="form-input">
